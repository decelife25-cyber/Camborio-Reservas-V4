...
export default function HorarioConfiguracion({onBack}:Props){
 ...
 return <section className="cr-config-horarios"><h3>🕒 HORARIOS</h3>{loading?<div className="cr-horario-vacio">CARGANDO HORARIOS...</div>:<>
